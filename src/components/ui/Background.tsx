  ...
  return (
    <div className="fixed inset-0 pointer-events-none overflow-hidden" style={{ zIndex: 0 }}>
      ...
      {codeLines.map((line, i) => (
        <div
          key={i}
          className="absolute font-mono text-[11px] text-amber-400/[0.08] whitespace-nowrap select-none"
      ...
      {symbols.map((sym, i) => (
        <div
          key={`sym-${i}`}
          className="absolute font-mono text-amber-400/[0.05] select-none"
      ...
      <svg className="absolute inset-0 w-full h-full" preserveAspectRatio="none">
        <line x1="0" y1="50%" x2="15%" y2="50%" stroke="rgba(245,158,11,0.08)" strokeWidth="1" />
        <line x1="15%" y1="50%" x2="17%" y2="48%" stroke="rgba(245,158,11,0.08)" strokeWidth="1" />
        <line x1="17%" y1="48%" x2="30%" y2="48%" stroke="rgba(245,158,11,0.08)" strokeWidth="1" />
        <circle cx="15%" cy="50%" r="3" fill="rgba(245,158,11,0.15)" />
        <circle cx="30%" cy="48%" r="3" fill="rgba(245,158,11,0.15)" />

        <line x1="100%" y1="30%" x2="85%" y2="30%" stroke="rgba(217,119,6,0.08)" strokeWidth="1" />
        <line x1="85%" y1="30%" x2="83%" y2="32%" stroke="rgba(217,119,6,0.08)" strokeWidth="1" />
        <line x1="83%" y1="32%" x2="70%" y2="32%" stroke="rgba(217,119,6,0.08)" strokeWidth="1" />
        <circle cx="85%" cy="30%" r="3" fill="rgba(217,119,6,0.15)" />
        <circle cx="70%" cy="32%" r="3" fill="rgba(217,119,6,0.15)" />
      </svg>
    </div>
  );
}

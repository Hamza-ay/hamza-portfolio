...
export default function MentionsLegales() {
  return (
    <main className="min-h-screen bg-[#0a0a0f] text-mist-200 py-24 px-4 sm:px-6">
      <div className="max-w-3xl mx-auto">
        <Link
          href="/"
          className="inline-flex items-center gap-2 text-sm text-accent-400 hover:text-accent-300 mb-8 transition-colors"
        >
        ...
        <div className="space-y-8 text-mist-400 leading-relaxed">
          <section>
            <h2 className="text-xl font-semibold text-white mb-3">
              1. Éditeur du site
            </h2>
            <p>
              Ce site est édité par <strong className="text-mist-200">Hamza AIT YAHIATENE</strong>,
              personne physique.
            </p>
          ...
          <section>
            ...
            <p>
              Ce site est hébergé par <strong className="text-mist-200">GitHub Pages</strong>,
          ...
          <section>
            ...
            <p>
              ...
              <strong className="text-mist-200"> Aucune donnée personnelle n&apos;est collectée,
              stockée ou traitée</strong> par ce site.
            </p>
            <ul className="mt-3 space-y-2 text-sm">
              <li>
                <strong className="text-mist-300">Formulaire de contact :</strong> Le formulaire
                ouvre votre client email (mailto:). Aucune donnée n&apos;est transmise à un serveur.
              </li>
              <li>
                <strong className="text-mist-300">Cookies :</strong> Ce site n&apos;utilise aucun
                cookie ni traceur analytique.
              </li>
              <li>
                <strong className="text-mist-300">Hébergeur :</strong> GitHub Pages peut collecter
          ...
          <section>
            ...
            <p>
              ...
              à l&apos;adresse : <a href="mailto:aityahiatenehamza0@gmail.com" className="text-accent-400 hover:text-accent-300 underline">aityahiatenehamza0@gmail.com</a>
            </p>
          </section>
        </div>

        <p className="mt-12 text-xs text-mist-600">
